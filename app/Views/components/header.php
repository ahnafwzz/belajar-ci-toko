...
<header id="header" class="header fixed-top d-flex align-items-center">
  ...
  <div class="search-bar">
    <form class="search-form d-flex align-items-center" method="GET" action="<?= base_url('/') ?>">
        <input type="text" name="keyword" placeholder="Cari laptop atau produk..." title="Enter search keyword" value="<?= isset($_GET['keyword']) ? esc($_GET['keyword']) : '' ?>">
    ...
    <ul class="d-flex align-items-center">
      ...
      <li class="nav-item dropdown pe-3">
        ...
        <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
          ...
          <span class="d-none d-md-block dropdown-toggle ps-2 text-capitalize"><?= session()->get('username'); ?> (<?= session()->get('role'); ?>)</span>
        </a>
